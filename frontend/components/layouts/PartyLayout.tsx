...
export const PartyLayout: React.FC<PartyLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {/* Sidebar */}
      <div className={`
        w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col fixed h-screen z-50
      ...
      <div className="flex-1 flex flex-col lg:ml-64">
        {/* Top Header */}
        {showHeader && (
          <div className="bg-white border-b border-gray-200 px-4 lg:px-6 py-4 sticky top-0 z-30 shadow-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                {/* Mobile Menu Button */}
                <button
                ...
                <div>
                  ...
                  {subtitle && <p className="text-xs lg:text-sm text-gray-600">{subtitle}</p>}
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <div className="px-2 lg:px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs lg:text-sm font-medium">
